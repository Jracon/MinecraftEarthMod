...
public class SkewbaldChickenRenderer extends MobRenderer<GenericChickenEntity, ChickenModel<GenericChickenEntity>> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(MCEarth.MOD_ID, "textures/entity/chickens/skewbald_chicken.png");

    public SkewbaldChickenRenderer(EntityRendererProvider.Context context) {
        super(context, new ChickenModel<>(context.bakeLayer(new ModelLayerLocation(new ResourceLocation("mcearth", "skewbald_chicken"), "main"))), 0.3f);
    }
