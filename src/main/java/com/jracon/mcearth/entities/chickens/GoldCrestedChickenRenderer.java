...
public class GoldCrestedChickenRenderer extends MobRenderer<GenericChickenEntity, ChickenModel<GenericChickenEntity>> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(MCEarth.MOD_ID, "textures/entity/chickens/gold_crested_chicken.png");

    public GoldCrestedChickenRenderer(EntityRendererProvider.Context context) {
        super(context, new ChickenModel<>(context.bakeLayer(new ModelLayerLocation(new ResourceLocation("mcearth", "gold_crested_chicken"), "main"))), 0.3f);
    }
