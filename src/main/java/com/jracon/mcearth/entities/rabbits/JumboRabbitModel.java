...
public class JumboRabbitModel<T extends Entity> extends EntityModel<JumboRabbitEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("mcearth", "jumbo_rabbit"), "main");
    ...
    @Override
    public void setupAnim(JumboRabbitEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
