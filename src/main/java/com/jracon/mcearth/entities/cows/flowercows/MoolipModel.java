...
public class MoolipModel<T extends Entity> extends EntityModel<MoolipEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("mcearth", "moolip"), "main");
    ...
    public MoolipModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition flower = head.addOrReplaceChild("flower", CubeListBuilder.create().texOffs(52, -1).mirror().addBox(-2.5F, -34.0F, -4.0F, 0.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(52, 5).addBox(-5.5F, -34.0F, -1.0F, 6.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, 22.0F, -2.0F));
        ...
        PartDefinition flower2 = body.addOrReplaceChild("flower2", CubeListBuilder.create().texOffs(52, -1).mirror().addBox(-2.0F, -34.0F, -4.0F, 0.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(52, 5).addBox(-5.0F, -34.0F, -1.0F, 6.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.0F, -2.0F, -23.0F, -1.5708F, 0.0F, 0.0F));

        PartDefinition flower3 = body.addOrReplaceChild("flower3", CubeListBuilder.create().texOffs(52, -1).mirror().addBox(-2.0F, -34.0F, -4.0F, 0.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(52, 5).addBox(-5.0F, -34.0F, -1.0F, 6.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -2.0F, -24.0F, -1.5708F, 0.0F, 0.0F));

        PartDefinition flower4 = body.addOrReplaceChild("flower4", CubeListBuilder.create().texOffs(52, -1).mirror().addBox(-2.0F, -33.99F, -4.0F, 0.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(52, 5).addBox(-5.0F, -33.99F, -1.0F, 6.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, 6.0F, -22.0F, -1.5708F, 0.0F, 0.0F));
    ...
    @Override
    public void setupAnim(MoolipEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
