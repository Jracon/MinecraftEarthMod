...
public class GenericPigModel<T extends Entity> extends EntityModel<GenericPigEntity> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("mcearth", "generic_pig_model"), "main");
	...
	public GenericPigModel(ModelPart root) {
